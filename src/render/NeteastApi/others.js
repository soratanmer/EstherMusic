...
import { mapTrackPlayableStatus } from '@render/utils/common'
...
export function search(params) {
    return request({
        ...
        if (data.result?.song !== undefined) data.result.song.songs = mapTrackPlayableStatus(data.result.song.songs)
        return data
    })
}
